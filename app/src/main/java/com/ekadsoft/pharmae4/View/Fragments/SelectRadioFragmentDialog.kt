...
import com.ekadsoft.pharmae4.View.Adapters.RadioCompanyAdapter
import kotlinx.android.synthetic.main.select_dialog_fragment.view.*
import java.util.*

class SelectRadioFragmentDialog(
    var title: String,
    observableFieldName: ObservableField<String>,
    observableFieldId: ObservableField<String>
) : DialogFragment() {
    var name = ""
    var id = ""
    var page = 1
    ...
    var adapter: RadioCompanyAdapter? = null
    lateinit var vieww: View

  lateinit var  observableFieldName: ObservableField<String>
  lateinit var  observableFieldId: ObservableField<String>

    init {
        this.observableFieldId = observableFieldId
        this.observableFieldName = observableFieldName
    }
    ...
    private fun initView( ) {
        ...
        vieww. ok.setOnClickListener(View.OnClickListener {
            if (id != "") {
                ...
                observableFieldName.set(name)
                observableFieldId.set(id)
                dismiss()
    ...
    private val data: Unit
        private get() {
            ...
            adapter = RadioCompanyAdapter(this, list)
