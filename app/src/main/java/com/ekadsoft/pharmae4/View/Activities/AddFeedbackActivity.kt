...
import com.ekadsoft.pharmae4.Images.imagePicker.Camera.GALLERY_REQUEST
...
class AddFeedbackActivity : AppCompatActivity() {
    ...
    lateinit var binding: com.ekadsoft.pharmae4.databinding.ActivityAddFeedbackBinding
